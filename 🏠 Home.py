...
with guiuan_tab:
    components.html(
        '<iframe width="100%" width="80%" src="https://embed.windy.com/embed.html?type=map&location=coordinates&metricRain=mm&metricTemp=°C&metricWind=km/h&zoom=8&overlay=satellite&product=satellite&level=surface&lat=11.1&lon=125.7&pressure=true" frameborder="0"></iframe>',
        height=610
        )
    components.html(
