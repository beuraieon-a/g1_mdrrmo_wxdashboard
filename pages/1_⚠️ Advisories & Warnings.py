...
with weather_tab:
    ...
    with col1:
        ...
        legend_tstm_content = legend_tstm.container(horizontal=True, horizontal_alignment='left', border=True)
    ...
    with col2:
        ...
        legend_tcws_content = legend_tcws.container(horizontal=True, horizontal_alignment='left', border=True)
